...
def Generate_Data(Name,Roll_no):
    ...
    def enter_CSV(name,roll_no):
        ...
        df=pd.read_csv("C:/Users/admin/Downloads/Smart-Attendance-System-using-Face-Recognition-master/Smart-Attendance-System-using-Face-Recognition-master/Students_Enrollment.csv")
        df=df.append({'Name':name, 'Roll Number': roll_no},ignore_index=True)
        df.to_csv("C:/Users/admin/Downloads/Smart-Attendance-System-using-Face-Recognition-master/Smart-Attendance-System-using-Face-Recognition-master/Students_Enrollment.csv",index=False)
        return
    ...
    fa=cv2.CascadeClassifier('C:/Users/admin/Downloads/Smart-Attendance-System-using-Face-Recognition-master/FaceDetection/faces.xml')
